...
SELECT p.Name,od.Quantity  FROM order_detail as od JOIN Products as p on p.ProductID = od.ProductID 
JOIN Orders as o ON o.OrderID = od.OrderID WHERE o.OrderID = 2