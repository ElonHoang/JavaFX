                ...
                if(equal(Integer.parseInt(id.getText()) ,user.getText())){
                    if(Validation()){
                        ...
                        pt.play();  
                            ...
                            alert.setTitle("Không thể chỉnh sửa đơn");
                            alert.setHeaderText("Có thể bạn hiện không phải là khách hàng hợp lệ hoặc hệ thống đang bị lỗi");
                            alert.showAndWait();
                            //show.setVisible(true);
                    ...
                    pt.play();
                        ...
                        Alert alert = new Alert(AlertType.WARNING);
                            alert.setTitle("Không thể đặt hàng");
                            alert.setHeaderText("Có thể bạn hiện không phải là khách hàng hợp lệ hoặc hệ thống đang bị lỗi");
                            alert.showAndWait();
                        //show.setVisible(true);
                        //error.setVisible(true);
